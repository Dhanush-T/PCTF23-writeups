...
var wasmBinaryFile = 'rickroll.wasm';
...
var ASM_CONSTS = {
  1024: function($0) {let numericalString = UTF8ToString($0); let binaryString = ""; for (let i = 0; i < numericalString.length; i++) { let digit = parseInt(numericalString.charAt(i)); binaryString += digit.toString(2).padStart(4, "0"); } let encodedSequence = ""; for (let i = 0; i < binaryString.length; i += 2) { let bits = binaryString.substr(i, 2); switch (bits) { case "00": encodedSequence += "A"; break; case "01": encodedSequence += "C"; break; case "10": encodedSequence += "G"; break; case "11": encodedSequence += "T"; break; default: encodedSequence += "N"; break; } } console.log(encodedSequence); if(encodedSequence==="AGCTAAAGAGAAAGAG"){ eval(atob('YWxlcnQoJ0NvbmdyYXRzLiBIZXJlIGlzIHlvdXIgZmxhZzogcF9jdGZ7YzBtYkluNHRpMG5fMGZfRDRBX20wcnMzYzBkM18xc19mdTR9Jyk7')); return 1; } return 0;}
};
...
/** @type {function(...*):?} */
var _validateFlag = Module["_validateFlag"] = createExportWrapper("validateFlag");
